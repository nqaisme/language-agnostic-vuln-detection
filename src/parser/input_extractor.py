import torch, numpy as np, tree_sitter_language_pack as tslp
...
class cb_input_extractor:
    ...
    def __call__(self, source_codes: str| List[str]):
...
class gcb_input_extractor:
    ...
    def __call__(self, source_codes: str | List[str]):
        ...
        for source_code in source_codes:
            ...
            batch_input_ids.append(source_ids)
            batch_position_ids.append(position_idx)
